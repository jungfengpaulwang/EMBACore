...
{
    public partial class CS_Template_CourseAttendance_ByDate : BaseForm
    {
        private UDT.CSConfiguration conf;
        private UDT.CSConfiguration conf_subject;
        private string TemplateName_Subfix = "course-attend-reminder-bydate";
        private bool formload;
        private object CurrentObject;

        public CS_Template_CourseAttendance_ByDate()
        {
            InitializeComponent();
            ...
            this.btnAttendDate.Click += new System.EventHandler(this.btn_Click);
