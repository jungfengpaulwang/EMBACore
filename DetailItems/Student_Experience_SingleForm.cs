...
{
    public partial class Student_Experience_SingleForm : UDTDetailContentBase.UDTSingleForm
    {
        ...
        public Student_Experience_SingleForm()
        {
            InitializeComponent();
        ...
        {
            UDT.Experience exp = (UDT.Experience)this._target;
            exp.Company = this.txtCompany.Text;
            exp.Position =this.txtPosition.Text ;
